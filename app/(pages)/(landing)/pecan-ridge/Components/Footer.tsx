...
export default function Footer() {
  return (
    <footer
      className="relative z-10 text-white py-10"
      style={{
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-6 py-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-10 mb-10">
          ...
          <div className="flex gap-3">
            <Link
              href="#"
              aria-label="Facebook"
              className="w-10 h-10 bg-white/15 hover:bg-emerald-400/80 text-slate-100 hover:text-white rounded-full flex items-center justify-center transition-colors"
            >
        ...
        <div className="border-t border-slate-800 pt-6 text-center">
          <p className="text-slate-200 text-xs md:text-sm tracking-wide">
